...
//dribble
const double MAX_BALL_RANGE=0.115; // Could maybe be even less? Is a LOT lower in real life, think max 0.05 m.
...
const double standard_luth_P = 2.9;
const double standard_luth_I = 0.1;
const double standard_luth_D = 3.7;
